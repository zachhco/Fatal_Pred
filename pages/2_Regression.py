...
st.markdown('# Fatality Predictor - Regression Model')
st.sidebar.markdown("# Fatality Predictor - Regression Model")
st.sidebar.markdown("Interactive crash risk prediction tool which, given a set of user inputs, predicts the probability of a fatal crash.")
st.sidebar.markdown("The underlying model is a random forest regressor trained on the NHTSA's FARS dataset. The model uses a variety of\
                     features to predict the probability of a fatal crash.")
...
with right_col:
   ...
   # Prediction button and handling
    if st.button('Predict'):
        ...
        # Optionally, you might want to visualize this probability or use a threshold to display categorical results
        ...
        st.markdown('The prediction is that the subject will experince: **{}**'.format(prediction_category))

        # Display the corresponding image
        image_path = 'death.png' if prediction_category == 'Death' else 'life.png'
        st.image(image_path)
